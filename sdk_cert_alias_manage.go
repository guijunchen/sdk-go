...
func (cc *ChainClient) AddAlias() (*common.TxResponse, error) {
	cc.logger.Infof("[SDK] begin to add alias, [contract:%s]/[method:%s]",
		syscontract.SystemContract_CERT_MANAGE.String(), syscontract.CertManageFunction_ALIAS_CERT_ADD.String())
	...
	payload := cc.CreateCertManagePayload(syscontract.CertManageFunction_ALIAS_CERT_ADD.String(), kvs)
...
func (cc *ChainClient) QueryCurrentAlias(alias string) (*syscontract.AliasInfo, error) {
	cc.logger.Infof("[SDK] begin to query cert by alias, [contract:%s]/[method:%s]",
		syscontract.SystemContract_CERT_MANAGE.String(), syscontract.CertManageFunction_ALIAS_QUERY_CURRENT_CERT.String())
	...
	payload := cc.createPayload("", common.TxType_QUERY_CONTRACT, syscontract.SystemContract_CERT_MANAGE.String(),
		syscontract.CertManageFunction_ALIAS_QUERY_CURRENT_CERT.String(), kvs, defaultSeq)
	...
	aliasInfo := &syscontract.AliasInfo{}
...
func (cc *ChainClient) QueryCertByAliasAndBlockHeight(alias, blockHeight string) (*syscontract.AliasCertInfo, error) {
	cc.logger.Infof("[SDK] begin to query cert by alias, [contract:%s]/[method:%s]",
		syscontract.SystemContract_CERT_MANAGE.String(),
		syscontract.CertManageFunction_ALIAS_QUERY_CERT_BY_BLOCK_HEIGHT.String())
	...
	payload := cc.createPayload("", common.TxType_QUERY_CONTRACT, syscontract.SystemContract_CERT_MANAGE.String(),
		syscontract.CertManageFunction_ALIAS_QUERY_CERT_BY_BLOCK_HEIGHT.String(), kvs, defaultSeq)
	...
	aliasCertInfo := &syscontract.AliasCertInfo{}
...
func (cc *ChainClient) CreateUpdateAliasPayload(alias, certPEM string) *common.Payload {
	...
	return cc.CreateCertManagePayload(syscontract.CertManageFunction_ALIAS_CERT_UPDATE.String(), pairs)
}
