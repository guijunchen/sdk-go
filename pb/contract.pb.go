...
const (
	...
	// 系统链上多签收集合约
	ContractName_SYSTEM_CONTRACT_MULT_SIGN ContractName = 3
)
...
var file_contract_proto_rawDesc = []byte{
	...
	0x2a, 0x8b, 0x01, 0x0a, 0x0c, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x4e, 0x61, 0x6d,
	...
	0x43, 0x54, 0x5f, 0x4d, 0x55, 0x4c, 0x54, 0x5f, 0x53, 0x49, 0x47, 0x4e, 0x10, 0x03, 0x2a, 0xcb,
	...
	0x59, 0x10, 0x02, 0x2a, 0x30, 0x0a, 0x10, 0x4d, 0x75, 0x6c, 0x74, 0x53, 0x69, 0x67, 0x6e, 0x46,
	0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x07, 0x0a, 0x03, 0x52, 0x45, 0x51, 0x10, 0x00,
	0x12, 0x08, 0x0a, 0x04, 0x56, 0x4f, 0x54, 0x45, 0x10, 0x01, 0x12, 0x09, 0x0a, 0x05, 0x51, 0x55,
	0x45, 0x52, 0x59, 0x10, 0x02, 0x42, 0x3b, 0x0a, 0x18, 0x6f, 0x72, 0x67, 0x2e, 0x63, 0x68, 0x61,
...
var file_contract_proto_goTypes = []interface{}{
	...
	(*ContractId)(nil),          // 6: pb.ContractId
	(*ContractInfo)(nil),        // 7: pb.ContractInfo
	(*ContractTransaction)(nil), // 8: pb.ContractTransaction
}
var file_contract_proto_depIdxs = []int32{
	2, // 0: pb.ContractId.runtime_type:type_name -> pb.RuntimeType
	8, // 1: pb.ContractInfo.contract_transaction:type_name -> pb.ContractTransaction
	6, // 2: pb.ContractTransaction.contract_id:type_name -> pb.ContractId
