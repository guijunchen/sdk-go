...
// 用户合约管理方法集
type UserContractManagerFunction int32

const (
	// 创建
	UserContractManagerFunction_INIT_CONTRACT UserContractManagerFunction = 0
	// 升级
	UserContractManagerFunction_UPGRADE_CONTRACT UserContractManagerFunction = 1
	// 冻结
	UserContractManagerFunction_FREEZE_CONTRACT UserContractManagerFunction = 2
	// 解冻
	UserContractManagerFunction_UNFREEZE_CONTRACT UserContractManagerFunction = 3
	// 吊销
	UserContractManagerFunction_REVOKE_CONTRACT UserContractManagerFunction = 4
)

// Enum value maps for UserContractManagerFunction.
var (
	UserContractManagerFunction_name = map[int32]string{
		0: "INIT_CONTRACT",
		1: "UPGRADE_CONTRACT",
		2: "FREEZE_CONTRACT",
		3: "UNFREEZE_CONTRACT",
	...
	UserContractManagerFunction_value = map[string]int32{
		"INIT_CONTRACT":     0,
		"UPGRADE_CONTRACT":  1,
		"FREEZE_CONTRACT":   2,
		"UNFREEZE_CONTRACT": 3,
...
func (x UserContractManagerFunction) Enum() *UserContractManagerFunction {
	p := new(UserContractManagerFunction)
	*p = x
	return p
}

func (x UserContractManagerFunction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (UserContractManagerFunction) Descriptor() protoreflect.EnumDescriptor {
	return file_contract_proto_enumTypes[6].Descriptor()
}

func (UserContractManagerFunction) Type() protoreflect.EnumType {
	return &file_contract_proto_enumTypes[6]
}

func (x UserContractManagerFunction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use UserContractManagerFunction.Descriptor instead.
func (UserContractManagerFunction) EnumDescriptor() ([]byte, []int) {
...
var file_contract_proto_rawDesc = []byte{
	...
	,
}
...
var file_contract_proto_goTypes = []interface{}{
	...
	(UserContractManagerFunction)(0), // 6: pb.UserContractManagerFunction
