...
replace_go_package:
	${SED} "s%chainmaker.org/chainmaker-go/pb/protogo%chainmaker.org/chainmaker/pb-go%g" pb/proto/*/*.proto

reset_go_package:
	${SED} "s%chainmaker.org/chainmaker/pb-go%chainmaker.org/chainmaker-go/pb/protogo%g" pb/proto/*/*.proto
